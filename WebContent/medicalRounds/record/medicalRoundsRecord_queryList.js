...
function initStaffInfo() {
	...
	$("#xunzhenjilu").bootstrapTable(
			{
				url : 'StaffInfo/queryallstaffinfo4.asp',
				method : 'get', //请求方式（*）   
...
(function(){
	...
	//新增行员信息
	getCurrentPageObj().find("#xunzhenjiluadd").unbind("click");
	getCurrentPageObj().find("#xunzhenjiluadd").click(function(){
		closeAndOpenInnerPageTab("xunzhenjiluadd","新增巡诊记录","medicalRounds/record/medicalRoundsRecord_add.html",function(){});
	});
	//修改查询行员信息

...
function initStaffInfo() {
	...
	$("#xunzhenlist").bootstrapTable(
			{
				url : 'StaffInfo/queryallstaffinfo2.asp',
				method : 'get', //请求方式（*）
...
(function(){
	...
	getCurrentPageObj().find("#customInfoAdd").click(function(){
		closeAndOpenInnerPageTab("customInfoAdd","新增巡诊信息","medicalRounds/basic_info/medicalRounds_add.html",function(){});
	});
	//修改查询行员信息

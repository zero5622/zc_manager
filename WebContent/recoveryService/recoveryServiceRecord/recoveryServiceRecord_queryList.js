...
(function(){
	...
	//新增行员信息
	getCurrentPageObj().find("#fuwuadd").unbind("click");
	getCurrentPageObj().find("#fuwuadd").click(function(){
		closeAndOpenInnerPageTab("fuwuadd","新增服务记录","recoveryService/recoveryServiceRecord/recoveryServiceRecord_add.html",function(){});
	});
	//修改查询行员信息

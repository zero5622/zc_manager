...
function initStaffInfo() {
	autoInitSelect($("#customServiceAssessInfoList"));
	$("#customServiceAssessInfoList").bootstrapTable(
			{
				url : 'StaffInfo/queryallstaffinfo.asp',
				method : 'get', //请求方式（*）   
...
(function(){
	...
	//新增行员信息
	getCurrentPageObj().find("#customServiceAssessAdd").unbind("click");
	getCurrentPageObj().find("#customServiceAssessAdd").click(function(){
		closeAndOpenInnerPageTab("customServiceAssessAdd","录入评定信息","custom_manage/custom_service_assess/custom_service_assess_add.html",function(){});
	});
	//修改查询行员信息

...
function EciticTitleI(){
    // $(".ecitic-title i").click(function(){
    	$(document).on("click",".ecitic-title i",function () {
          if($(this).is(".open")){
...
//跨域请求url配置说明
///////////////////////////////192.168.1.109
var dev_application="http://"+location.hostname+":8080/dev_application/";//应用及工单管理
var dev_background="http://"+location.hostname+":8080/dev_background/";//后台管理
...
var dev_test="http://"+location.hostname+":8096/dev_test/";//资源管理
var dev_workbench="http://"+location.hostname+":8017/dev_workbench/";//督办及工作台管理 
var dev_outsource="http://"+location.hostname+":8888/dev_outsource/";//外包管理

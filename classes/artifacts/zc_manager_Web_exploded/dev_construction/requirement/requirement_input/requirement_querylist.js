...
function initRequirementListLayout1(){
	...
	function initRequirementListLayout() {
		...
		query.click(function() {
			...
			table.bootstrapTable('refresh',{url:dev_construction+"requirement_input/queryRequirementInfoList.asp?SID="+SID+
		...
		currTab.find('#delete').click(function(){
			...
			baseAjaxJsonp(dev_construction+"requirement_input/deleteRequirementInfo.asp?SID="+SID+"&req_id="+ids+"&req_state="+REQ_STATE, null , function(data) {
 ...
 currTab.find("#create_person_name_reqquery").click(function(){
	...
	function initReuirementQueryTable() {
			...
			table.bootstrapTable("destroy").bootstrapTable({
						url :dev_construction+"requirement_input/queryRequirementInfoList.asp?SID="+SID+"&call="+reqQueryListCall,
						method : 'get', // 请求方式（*）

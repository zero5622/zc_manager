...
function initreqConvertApply(){
	...
	query.click(function(){
		...
		table.bootstrapTable('refresh',{
			url:dev_construction+'ReqConvert/queryReqConvertList.asp?call='+tableCall+'&SID='+SID+'&'+param});
	...
	table.bootstrapTable({
		//请求后台的URL（*）
		url : dev_construction+'ReqConvert/queryReqConvertList.asp?call='+tableCall+'&SID='+SID,
		method : 'get', //请求方式（*）   

...
function initTaskAnalyListBtnp() {
	...
	getCurrentPageObj().find("#serach_P").click(function() {
		...
		var req_task_state = curTab.find('#req_task_stateTO').val();
		...
		getCurrentPageObj().find('#pGFollowerTaskTable').bootstrapTable('refresh',{
			...
			+'&req_task_relation='+req_task_relation+'&old_task_id='+old_task_id+'&req_task_type='+req_task_type+'&personal=personal'
		});
	});

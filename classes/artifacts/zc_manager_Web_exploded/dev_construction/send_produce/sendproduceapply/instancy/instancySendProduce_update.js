...
function initSendProduceInstancyApply(audit_no){
	...
	addfile.click(function(){
	  ...
	  openFileFtpUpload(currTab.find("#file_modalInstancyU"), tablefile, 'GZ1062',business_code, '12', 'G_DIC_SEND_IPRODUCE_FILE', false, true,paramObj);
	});
	 ...
	 getFtpFileList(tablefile, currTab.find("#file_view_modalInstancyU"),business_code, "12");
}

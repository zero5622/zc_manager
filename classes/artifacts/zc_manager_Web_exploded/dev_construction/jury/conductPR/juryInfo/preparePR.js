	...
	var tablefile = currTab.find("#table_file");
	 ...
	 addfile.click(function(){
		...
		var req_task_state = currTab.find("#req_task_state").val();
		 ...
		 if("03"==req_task_state){
			 ...
			 openFileFtpUpload(currTab.find("#file_modal"), tablefile, 'GZ1064',business_code, '00', 'S_DIC_JURY_RESULT_FILE', false, true, paramObj);
		 } else {
			 ...
			 openFileFtpUpload(currTab.find("#file_modal"), tablefile, 'GZ1065',business_code, '00', 'S_DIC_JURY_RESULT_FILE', false, true, paramObj);
		 }
	 });
	 ...
	 delete_file.click(function(){
		var business_code = getCurrentPageObj().find("input[name=FILE_ID]").val();
	 	delFtpFile(tablefile, business_code, "00", currTab.find("#file_modal"));
	 });

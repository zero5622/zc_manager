...
parent.window.selProjectInfo=function(index){
	...
	if(P_BACKLOG!=""&&P_BACKLOG!=undefined){
		if(P_BACKLOG=='质量不符合项提出待受理'){
			...
			window.parent.iframeOpenTab("split_les_task","需求任务拆分","dev_construction/requirement/requirement_analyze/split_task/splitTask_querylist.html");
			...
			window.parent.iframeOpenTab("sendproapply_info","投产申请","dev_construction/send_produce/sendproduceapply/sendProduceApply_queryList.html");
			...
			window.parent.iframeOpenTab("op_enter_approve","外包人员入场审批","dev_outsource/employee/outpersonEntrance/outpersonEntrance_queryList.html");
		}else if(P_BACKLOG=='外包人员离场待审批'){
			window.parent.iframeOpenTab("op_leave_approve","外包人员离场审批","dev_outsource/employee/outpersonDeparture/outpersonDeparture_queryList.html");
		}
	}
};

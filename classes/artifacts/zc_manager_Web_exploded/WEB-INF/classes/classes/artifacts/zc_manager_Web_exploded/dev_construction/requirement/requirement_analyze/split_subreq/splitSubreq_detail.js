...
function initReqDetailFileList(){
 ...
 getFtpFileList(tablefile,getCurrentPageObj().find("#reqSpd_fileview_modal"),business_code,"0101");
//初始化需求工作量评估附件列表
 var ass_tablefile = getCurrentPageObj().find("#reqSpdAss_tablefile");
 getFtpFileList(ass_tablefile,getCurrentPageObj().find("#reqSpdAss_fileview_modal"),business_code,"0102");
}

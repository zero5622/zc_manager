...
function initReqDetailFileList(){
 ...
 getFtpFileList(tablefile,getCurrentPageObj().find("#reqSP_fileview_modal"), business_code, "0101");
 //初始化需求评估信息附件列表
 //var ass_file_id = getCurrentPageObj().find("#SPAssfile_id").val();
 var ass_tablefile = getCurrentPageObj().find("#reqAssSP_tablefile");
 getFtpFileList(ass_tablefile, getCurrentPageObj().find("#reqAssSP_fileview_modal"), business_code, "0102");
}

...
function initStaffInfo() {
	autoInitSelect($("#customServiceInfoList"));
	$("#customServiceInfoList").bootstrapTable(
			{
...
(function(){
	...
	getCurrentPageObj().find("#customInfoAdd").click(function(){
		closeAndOpenInnerPageTab("customInfoAdd","新增客户信息","custom_manage/custom_Info/customInfo_add.html",function(){});
	});
	//修改查询行员信息

...
function initStaffInfo() {
    autoInitSelect($("#customVisitInfoList"));
    $("#customVisitInfoList").bootstrapTable(
        {
...
(function(){
    ...
    getCurrentPageObj().find("#customInfoAdd").click(function(){
        closeAndOpenInnerPageTab("customInfoAdd","录入评定信息","custom_manage/custom_visit_info/custom_visitInfo_add.html",function(){});
    });
    //修改查询行员信息

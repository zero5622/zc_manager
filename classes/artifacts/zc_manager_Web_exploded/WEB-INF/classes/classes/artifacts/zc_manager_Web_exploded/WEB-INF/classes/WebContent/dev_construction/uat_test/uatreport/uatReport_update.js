...
function initUatReportInfo(data) {
	...
	addfile.click(function(){
		...
		openFileFtpUpload(currTab.find("#file_modal"), tablefile, 'GZ1061',business_code, '11', 'S_DIC_UAT_TEST_FILE', false, true, paramObj);
	});
	 //附件删除
	 var delete_file = currTab.find("#delete_file");
	 delete_file.click(function(){
	 	delFtpFile(tablefile, business_code, "10");
	 });
	 getFtpFileList(tablefile, currTab.find("#fileview_modal"), business_code, "10");
}
...
(function(){
	...
	getCurrentPageObj().find("#submitUatReprot").click(function() {
		...
		nconfirm("确定提交UAT测试报告吗？",function(){
			...
			items["biz_id"] = uatReportUpdateUUID;//业务id

			...
			<div class="ecitic-table" id="ecitic-table">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-bor-pad requirement-table">
					...
					<tr>
						...
						<td style="width:25%">
						<select id="req_state"  name="REQ.req_state" class="requirement-ele-width" style="width:100%;">
							<option value="">请选择</option>
...
/* 			$("#req_state").select2();
    ...
    $("#summit_time_start").val(curTime);
    $("#summit_time_start").attr("placeHolder",curTime);

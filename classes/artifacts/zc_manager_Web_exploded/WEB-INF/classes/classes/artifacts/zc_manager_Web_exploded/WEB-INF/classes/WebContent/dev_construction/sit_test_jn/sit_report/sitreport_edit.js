function initSitTestReportInfoLayout(item){
	...
	addfile.click(function(){
		openFileFtpUpload(currTab.find("#file_modal"), tablefile, "GZ1059003",business_codes, "09003", "S_DIC_SIT_TEST_FILE", true, true);
	});
	//附件删除
	var delete_file = currTab.find("#delete_file");
	delete_file.click(function(){
		delFtpFile(tablefile, business_codes, "09003", currTab.find("#file_modal"));
	});
	//初始化附件列表
	getFtpFileList(tablefile,currTab.find("#file_view_modal"),business_codes, "09003");

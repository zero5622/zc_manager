...
function initemsitSubmitEditBtn(item){
	...
	addfile.click(function(){
		...
		openFileFtpUpload(currTab.find("#edfile_modal"), tablefile, 'GZ1059002',business_code, '09002', 'S_DIC_SIT_DEPLOY_FILE', false, true, paramObj);
	});
	 //附件删除
	 ...
	 getFtpFileList(tablefile, getCurrentPageObj().find("#edfileview_modal"), business_code, "09002");

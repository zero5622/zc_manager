...
$('#saveForTaskAccept').click(function(){
	...
	baseAjaxJsonp(dev_construction+"requirement_splitTask/insertReqTask.asp?SID="+SID+"&req_id="+req_id+"&sub_req_code="+sub_req_code+"&sub_req_id="+sub_req_id+"&req_acc_classify="+req_acc_classify+"&involve_app="+involve_app+"&is_change="+is_change, taskInfo , function(data) {

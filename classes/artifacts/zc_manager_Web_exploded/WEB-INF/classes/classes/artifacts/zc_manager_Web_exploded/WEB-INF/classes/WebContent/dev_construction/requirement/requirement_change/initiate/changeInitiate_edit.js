...
/****************************************************************/	
	...
	function initFileTable(item) {
		 ...
		 addfile.click(function(){
		 	...
		 	openFileFtpUpload($page.find("#file_modal"), tablefile, 'GZ1072',business_code, '00', 'S_DIC_REQ_CHA_FILE', false, false, paramObj);
		 });
		 ...
		 getFtpFileList(tablefile, $page.find("#file_initiate_modal"), business_code, "01");

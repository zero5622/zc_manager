 ...
 */
 $(function(){
	 ...
	 $("#posi_add_add").click(function(){
		 ...
		 var tr="<tr>" +
			 "<td>" +
				 "<input type=\"hidden\" name=\"p_name"+(len1-1)+"\" />" +
				 "<input type=\"text\" validate=\"v.required\" id=\"p_name"+(len1-1)+"\" class=\"citic-ast\"  />" +
			 "</td>" +
			 "<td>" +
			 	"<input type=\"text\" id=\"p_starttime"+(len1-1)+"\" name=\"p_starttime\" onClick=\"WdatePicker({})\" valititle=\"点击选择\" validate=\"v.required\"  onchange=\"TimeCompare()\" class=\"input\" readonly/>" +
			 "</td>" +
			 "<td>" +
			 "	<textarea id=\"fuwuxiangmu"+(len1-1)+"\" name=\"p_memo\" class=\"citic-text-ast\"></textarea>" +
			 "</td>" +
             "<td>" +
             "	<textarea id=\"fuwuqingkuangmiaoshu"+(len1-1)+"\" name=\"p_memo\" class=\"citic-text-ast\"></textarea>" +
             "</td>" +
             "<td>" +
             "	<textarea id=\"kangfuyuan"+(len1-1)+"\" name=\"p_memo\" class=\"citic-text-ast\"></textarea>" +
             "</td>" +
             "<td>" +
             "	<textarea id=\"kehuhuojiashu"+(len1-1)+"\" name=\"p_memo\" class=\"citic-text-ast\"></textarea>" +
             "</td>" +
			 "<td>" +
			 "	<a name='delPosition' style='cursor: pointer;'>删除</a>" +
			 "</td>" +
			 "</tr>";

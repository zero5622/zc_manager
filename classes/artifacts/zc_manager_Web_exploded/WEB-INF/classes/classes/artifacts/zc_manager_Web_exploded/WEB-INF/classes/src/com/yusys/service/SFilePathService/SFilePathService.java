...
public class SFilePathService implements ISFilePathService{
	...
	//根据路径id获取并生成路径
	public Map<String, String> getFtpPathByPathId(Map<String, String> pmap, Map<String, Object> param) {
				...
				if(list!=null&&!list.isEmpty()){
					for(Map<String, String> map : list){
						...
						if("00".equals(tag_type)){
							...
							if("java.lang.String".equals(param.get(map.get("TAG_PARAM")).getClass().getName())){
...
//					realFilePath += "/" + ((String[])param.get("DIC_NAME"))[0];
					/*String dic_name = null;
					if("java.lang.String".equals(param.get("DIC_NAME").getClass().getName())){
						dic_name = (String)param.get("DIC_NAME");
					} else {
						dic_name = ((String[])param.get("DIC_NAME"))[0];
					}
					realFilePath += "/" + dic_name;*/
				}
			}

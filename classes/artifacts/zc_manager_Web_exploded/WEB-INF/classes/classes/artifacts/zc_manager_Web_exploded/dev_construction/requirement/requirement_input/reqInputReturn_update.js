...
function initRequirementUpdateBtn(){
	...
	function returnToSubmit(){
	    ...
	    baseAjaxJsonp(dev_construction+'requirement_input/updateRequirementInfo.asp?SID='+SID+'&p_owner='+'&req_state=02', params , function(data) {
...
function initReqReturnIncomeCss(){
	...
	addfile.click(function(){
		var paramObj = new Object();
	 	...
	 	openFileFtpUpload(getCurrentPageObj().find("#reqRR_filemodal"), tablefile, 'GZ1063',business_code, '0101', 'S_DIC_REQ_PUT_FILE', false,false, paramObj);
	});
	//附件删除
	...
	//初始化附件列表
	getFtpFileList(tablefile,getCurrentPageObj().find("#reqRR_fileview_modal"),business_code,"0101");
	...
	addfile.click(function(){
		var paramObj1 = new Object();
	 	...
	 	openFileFtpUpload(getCurrentPageObj().find("#reqAssRR_filemodal"), assTablefile, 'GZ1063',business_codeass, '0102', 'S_DIC_REQ_ACC_FILE', false,false, paramObj1);
	});
	//附件删除
	var delete_file = getCurrentPageObj().find("#reqRR_assDelfile");
	delete_file.click(function(){
		delFtpFile(assTablefile,business_codeass, "0102");
	});
	//初始化附件列表
	getFtpFileList(assTablefile,getCurrentPageObj().find("#reqAssRR_fileview_modal"),business_codeass,"0102");

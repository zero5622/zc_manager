function initSendProInfoConfirm(id,file_id){
	...
	currTab.find("#sendTaskInfo").click(function(){
		initSendProInfoTab2();
		getFtpFileList(getCurrentPageObj().find("#reviewadd_filetable"), getCurrentPageObj().find("#reqviewaAdd_modalfile"),(file_id||"") , "0101");
	});
	...
	//初始化附件列表
	getFtpFileList(tablefile, currTab.find("#file_view_modal"), id, "12");
}

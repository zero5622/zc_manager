<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
		...
		String org_name=user.getOrg_name()==null?"":user.getOrg_name();
	...
	<div class="main_header">
		<div class="headerArea">
			...
			<ul class="rightTopHelp">
				...
				<li class="ecitic-set" style="display:none;" ><i class="fa fa-question-circle" aria-hidden="true"></i>知识库<b></b></li>
				<li class="ecitic-exit" id="ecitic-exit"><i class="fa fa-power-off" aria-hidden="true"></i>退出</li>
			</ul>
			<!-- 其他模块 -->
			<i class="user-astSYS" style="right: 200px"></i>
			<div class="cgb-system-content" id="cgb-system-content" style="width: 220px">
				...
				<div class="cgb-system-k" id="cgb-system-k" style="width: 220px;"></div>
			...
			<div class="ecitic-user-content">
				<div class="">
					...
					<div class="user-Info" >
						...
						<ul>
							<li>工号 : <%=view_no %></li>
							<li title="<%=org_no_name %>">部门 : <%=org_no_name %></li>
...
<script type="text/javascript">
    ...
    function remindOpenTab(P_BACKLOG){
        ...
        if(P_BACKLOG=="任务待受理"){
           ...
           iframeOpenTab('sendproapply_info','投产申请','dev_construction/send_produce/sendproduceapply/sendProduceApply_queryList.html');
        }
    }
	//侧边栏收合
